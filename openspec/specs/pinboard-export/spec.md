# pinboard-export Specification

## Purpose

Server-driven **whole pinboard** ZIP exports as `human.artifacts` jobs (`kind = 'pinboard_export'`), with binaries in private Storage and optional knowledge document snapshots for pins that reference a `source_document_uid`.

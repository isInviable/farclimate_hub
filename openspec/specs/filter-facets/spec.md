...
- **THEN** each category (sectors, climate_impacts, adaptation_approaches, keywords) SHALL be a list of objects with at least `value` (string) and `count` (number), ordered by count descending

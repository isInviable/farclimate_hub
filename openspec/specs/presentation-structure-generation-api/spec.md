# presentation-structure-generation-api Specification

## Purpose

Generate validated presentation JSON structures from selected pinboard context using a server-side LLM endpoint.

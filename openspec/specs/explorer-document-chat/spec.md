# Explorer document chat

End-to-end behavior of the explorer’s document-scoped chat: `POST /api/chat` with the Vercel AI SDK UI message stream, `@ai-sdk/vue` `Chat` on the client, and Nuxt UI chat components.
